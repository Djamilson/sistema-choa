        ...
        {files.length > 0 &&
          files.map((file) => {
            return (
              <div
                key={file.id}
                className="flex flex-col border bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800"
              >
                <div className="flex p-4">
                  <span className="mr-5 flex">
                    <div className="h-30 relative flex aspect-video overflow-hidden  bg-white p-2 shadow-lg transition-shadow duration-300 ease-in-out hover:transform">
                      <Image
                        width={500}
                        height={40}
                    ...
                    <span className="ml-5 min-w-0 text-sm">
                  ...
                  <div className="relative flex shrink-0 appearance-none items-center justify-end rounded-full pl-4 text-xs transition-colors duration-200 ease-in-out before:inline-block before:h-6 before:w-6 before:translate-x-0 before:transform before:transition before:duration-200 before:ease-in-out">
