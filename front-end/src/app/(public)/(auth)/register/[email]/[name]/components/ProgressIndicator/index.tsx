...
import ProcessIndicatorItem from '@/app/(public)/(auth)/signup/components/ProcessIndicatorItem'
    ...
    <div className="flex w-full flex-col items-center px-6">
      <div className="flex w-full items-center justify-between">
        ...
        >
          ...
          <motion.div
            variants={fadeIn({ direction: 'right', delay: 0.8, size: 40 })}
            initial="hidden"
            whileInView={'show'}
            viewport={{ once: false, amount: 0.6 }}
        ...
        <motion.div
          ...
          className={cn(
            ...
            currentStep === 2 ? 'text-green-600' : 'text-gray-300',
          )}
