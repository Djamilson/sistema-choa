...
interface IButtonDetailProductProps
...
const ButtonDetailProduct: FunctionComponent<IButtonDetailProductProps> = ({
  children,
  icon: Icon,
  isLoading,
  className,
  ...rest
}: IButtonDetailProductProps) => {
  return (
    <button
      className={cn(
